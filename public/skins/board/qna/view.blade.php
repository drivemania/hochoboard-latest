                ...
                <div class="flex items-start space-x-3 w-full">
                    ...
                    <div class="w-full">
                        <div class="flex items-center justify-between mb-1">
                            <span class="font-bold text-neutral-800 text-sm">{{ $document->nickname }} {{ $document->is_secret ? '🔒' : '' }}</span>
                            <span class="text-xs text-neutral-400">{{ date('Y.m.d H:i', strtotime($document->created_at)) }}</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button onclick="toggleReplyForm({{ $document->id }})" class="text-xs text-amber-600 font-semibold hover:underline flex items-center">
