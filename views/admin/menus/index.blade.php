...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-4 border-b bg-neutral-50">
        <p class="text-sm text-neutral-600">메뉴를 설정할 커뮤니티 그룹을 선택하세요.</p>
    </div>
        ...
        <tbody class="divide-y divide-neutral-200 text-sm">
            ...
            <tr class="hover:bg-neutral-50 transition">
                ...
                <td class="px-6 py-4 text-right">
                    <a href="{{ $base_path }}/admin/menus/{{ $g->id }}" class="bg-amber-500 text-white px-4 py-2 rounded hover:bg-amber-700 text-sm font-bold">
                        설정
                    </a>
                </td>
            </tr>
